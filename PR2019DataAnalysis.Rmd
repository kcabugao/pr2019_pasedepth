...
sandsiltclay <- read.csv("~/Documents/LabStats/PR2019/Sandsiltclay.csv", header = TRUE, stringsAsFactors = TRUE, na.strings = "NA")
sandsiltclay <- read.csv("~/Documents/LabStats/PR2019/Sandsiltclay.csv", header = TRUE, stringsAsFactors = TRUE, na.strings = "NA")
```
...
ggplot(data = rsa.sum, aes(x = Depth, y = mean)) +
...
ggplot(data = rsa.site, aes(x = Site, y = mean)) +
...
# root
ggplot(data = pairedpase, aes(x=surface.area, y=rootpase_vol)) + geom_point(aes(color = Site), size = 5, alpha = 0.5) +
...
# equation
cor(pairedpase$surface.area, pairedpase$rootpase_vol, use = "complete.obs") # 0.713
...
# soil
ggplot(data = pairedpase, aes(x=surface.area, y=soilpase_vol)) + geom_point(aes(color = Site), size = 5, alpha = 0.5) +
  geom_smooth(method = lm, se = FALSE, color = "black") +
  theme_bw() +
  theme(panel.grid = element_blank()) +
  xlab(expression(Mean~surface~area~(cm^{2}))) +
...
# equation
cor(pairedpase$surface.area, pairedpase$soilpase_vol, use = "complete.obs") # 0.259
...
# sand
ggplot(data = pase.mat, aes(x = Sand, y = SoilPase_vol)) +
  geom_point(aes(color = Site))

# clay
ggplot(data = pase.mat, aes(x = Clay, y = SoilPase_vol)) +
  geom_point(aes(color = Site, shape = Depth)) +
  geom_smooth(method = lm, se = FALSE, color = "black")

# Silt
ggplot(data = pase.mat, aes(x = Silt, y = SoilPase_vol)) +
  geom_point(aes(colour = Site))
```

### Soil texture x ResinP
```{r}
pase.mat <- pase.mat %>%
  replace_with_na(replace = list(ResinP_vol = 6.368))

# sand
ggplot(data = pase.mat, aes(x = Sand, y = ResinP_vol)) +
  geom_point(aes(color = Site))

# clay
ggplot(data = pase.mat, aes(x = Clay, y = ResinP_vol)) +
  geom_point(aes(color = Site)) +
  geom_smooth(method = lm, se = FALSE, color = "black")

# Silt
ggplot(data = pase.mat, aes(x = Silt, y = ResinP_vol)) +
  geom_point(aes(colour = Site)) +
  geom_smooth(method = lm, se = FALSE, color = "black")
```

### Soil texture x Organic P
```{r}
# sand
ggplot(data = pase.mat, aes(x = Sand, y = OrganicP)) +
  geom_point(aes(color = Site))

# clay
ggplot(data = pase.mat, aes(x = Clay, y =OrganicP)) +
  geom_point(aes(color = Site)) +

# Silt
ggplot(data = pase.mat, aes(x = Silt, y = OrganicP)) +
  geom_point(aes(colour = Depth))
```

### Soil texture x RootBiomass
```{r}
# sand
ggplot(data = pase.mat, aes(x = Sand, y = RootBiomass)) +
  geom_point(aes(color = Site))

# clay
ggplot(data = pase.mat, aes(x = Clay, y = RootBiomass)) +
  geom_point(aes(color = Site))

# Silt
ggplot(data = pase.mat, aes(x = Silt, y = RootBiomass)) +
  geom_point(aes(colour = Site))
```
