...
pase.bd.aov <- lm(BulkDens ~ Site + Depth + Site:Depth, data = pasecore)
summary(pase.bd.aov)
anova(pase.bd.aov)

# Site and Depth Letters
site.depth <- with(pasecore, interaction(Site, Depth))
pase.bd.mod <- lm(BulkDens ~ site.depth, data = pasecore)
bd.out <- HSD.test(pase.bd.mod , "site.depth", group = TRUE, alpha = 0.05)
print(bd.out)

# Site Letters. Use this for when there is one factor
model <- lm(BulkDens ~ Site, data = pasecore)
bd.site <- HSD.test(model, "Site", group = TRUE, alpha = 0.05)
print(bd.site)
...
summary(pase.organicp.aov)
anova(pase.organicp.aov)

# Site and Depth Letters
site.depth <- with(pasecore, interaction(Site, Depth))
pase.organicp.mod <- lm(rank.organicp ~ site.depth, data = pasecore)
organicp.out <- HSD.test(pase.organicp.mod, "site.depth", group = TRUE, alpha = 0.05)
print(organicp.out)
...
# Site and Depth Letters
site.depth <- with(pasecore, interaction(Site, Depth))
coarse.mod <- lm(rank.coarse ~ site.depth, data = pasecore)
coarse.out <- HSD.test(coarse.mod, "site.depth", group = TRUE, alpha = 0.05)
print(coarse.out)
...
summary(fineroot.aov)
anova(fineroot.aov)

# Site and Depth Letters
site.depth <- with(pasecore, interaction(Site, Depth))
fineroot.mod <- lm(rank.fine ~ site.depth, data = pasecore)
fineroot.out <- HSD.test(fineroot.mod, "site.depth", group = TRUE, alpha = 0.05)
print(fineroot.out)

# Site Letters. Use this for when there is one factor
model <- lm(rank.fine ~ Site, data = pasecore)
fineroot.site <- HSD.test(model, "Site", group = TRUE, alpha = 0.05)
print(fineroot.site)
```
...
# Site and Depth Letters
site.depth <- with(pasecore, interaction(Site, Depth))
percentp.mod <- lm(PercentP ~ site.depth, data = pasecore)
percentp.out <- HSD.test(percentp.mod, "site.depth", group = TRUE, alpha = 0.05)
print(percentp.out)
...
# Resin P x Soil Pase
ggplot(data = pasecore, aes(x = ResinP, y = SoilPase_g)) + geom_point() + 
  geom_smooth(method = "lm", colour = "black") + mytheme 
...
# Site and Depth Letters
site.depth <- with(shortcore, interaction(Site, Depth))
coarse.mod <- lm(paired.rank.coarse ~ site.depth, data = pasecore)
coarse.out <- HSD.test(coarse.mod, "site.depth", group = TRUE, alpha = 0.05)
print(coarse.out)
...
# Site and Depth Letters
site.depth <- with(shortcore, interaction(Site, Depth))
fineroot.mod <- lm(paired.rank.fineroot ~ site.depth, data = shortcore)
fineroot.out <- HSD.test(fineroot.mod, "site.depth", group = TRUE, alpha = 0.05)
print(fineroot.out)

# Site Letters. Use this for when there is one factor
model <- lm(paired.rank.fineroot~ Site, data = shortcore)
fineroot.site <- HSD.test(model, "Site", group = TRUE, alpha = 0.05)
print(fineroot.site)
```
...
# Site and Depth Letters
site.depth <- with(shortcore, interaction(Site, Depth))
rootsa.mod <- lm(RootSurfaceArea ~ site.depth, data = shortcore)
rootsa.out <- HSD.test(rootsa.mod, "site.depth", group = TRUE, alpha = 0.05)
print(rootsa.out)
...
# Site and Depth Letters
site.depth <- with(shortcore, interaction(Site, Depth))
resinp.mod <- lm(paired.rank.resinp ~ site.depth, data = shortcore)
resinp.out <- HSD.test(resinp.mod, "site.depth", group = TRUE, alpha = 0.05)
print(resinp.out)
...
# Site and Depth Letters
site.depth <- with(shortcore, interaction(Site, Depth))
orgp.mod <- lm(paired.rank.orgp ~ site.depth, data = shortcore)
orgp.out <- HSD.test(orgp.mod, "site.depth", group = TRUE, alpha = 0.05)
print(orgp.out)
...
# Site and Depth Letters
site.depth <- with(shortcore, interaction(Site, Depth))
rootpase.mod <- lm(paired.rank.rootpase ~ site.depth, data = shortcore)
rootpase.out <- HSD.test(rootpase.mod, "site.depth", group = TRUE, alpha = 0.05)
print(rootpase.out)
...
# Site and Depth Letters
site.depth <- with(shortcore, interaction(Site, Depth))
soilpase.mod <- lm(SoilPase_g ~ site.depth, data = shortcore)
soilpase.out <- HSD.test(soilpase.mod, "site.depth", group = TRUE, alpha = 0.05)
print(soilpase.out)
...
# Site and Depth Letters
site.depth <- with(shortcore, interaction(Site, Depth))
soilpase.mod <- lm(paired.rank.soilpase.vol ~ site.depth, data = shortcore)
soilpase.out <- HSD.test(soilpase.mod, "site.depth", group = TRUE, alpha = 0.05)
print(soilpase.out)
...
ggplot(data = shortcore, aes(x = RootSurfaceArea, y = RootPase_vol)) + geom_point() + 
  geom_smooth(method = "lm", colour = "black") + mytheme # not great
...
ggplot(data = shortcore, aes(x = ResinP, y = RootPase_vol)) + geom_point() + 
  geom_smooth(method = "lm", colour = "black") + mytheme

ls20 <- lm(RootPase_vol ~ ResinP, data = shortcore)
coef(ls20) 
summary(ls20) # eq: y = 0.078 - 0.004x; p = 0.207; r2 = 0.071
...
ls24 <- lm(SoilPase_g ~ RootSurfaceArea, data = shortcore)
coef(ls24) 
summary(ls24) # eq: y = 2.468 + 0.076x; p < 0.05; r2 = 0.225 # better
...
ggplot(data = shortcore, aes(x = ResinP, y = SoilPase_vol)) + geom_point() + mytheme 
ggplot(data = shortcore, aes(x = ResinP, y =  SoilPase_g)) + geom_point() + mytheme

# Total_OrgP x Soil Pase 
# is organic P by vol or by g?
ggplot(data = shortcore, aes(x = Total_OrgP, y = SoilPase_vol)) + geom_point() + mytheme 
